...
arquitetura <- function(num.entradas, num.escondidas, num.saida,
  ...
  #Pesos conectando a camada escondida e a camada de sa?da
...
mlp.retropropagacao <- function(arq, treino, n, limiar, rotulos.classes,max.epocas=2000){
  ...
  #Treinar enquanto o erroquadr?tico forma mior que um limiar e qtd de ?pocas 
  #for menor que 2000
  ...
  while (erroQuadratico > limiar && epocas <= max.epocas){
     ...
     #cat("\nEpoca", epocas," - Erro M?dio = ", erroQuadratico)
     epocas <- epocas + 1
  }
